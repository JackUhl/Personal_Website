...
import { bulletPoint, bulletPointConnector, mainText, divider, description, resumeItem, expander, resumeItemComponent, rotateExpanded, rotateCollapsed, resumeItemTitle } from "./ResumeItemComponent.module.css"

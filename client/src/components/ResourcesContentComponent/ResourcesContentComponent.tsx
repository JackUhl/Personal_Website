import { alignItemsCenter, flexColumn, justifyContentCenter, rowGapSmall } from "../../styling/shared.module.css";
...
export default function ResourcesContentComponent(props: IResourcesContentComponent) {
    return (
        <div className={classNameJoin([flexColumn, justifyContentCenter, alignItemsCenter, rowGapSmall])}>
